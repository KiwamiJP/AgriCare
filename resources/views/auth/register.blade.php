...
<div class="container">
    <div class="row justify-content-center min-vh-100 align-items-center">
        <div class="col-md-6">
            <div class="card shadow-lg border-0">
                <div class="card-header text-white text-center py-4 nature-gradient position-relative overflow-hidden">
                    ...
                    <h3 class="mb-0 fw-bold">{{ __('Join AgriCare') }}</h3>
                    <p class="small mb-0 mt-2">Cultivating a Greener Tomorrow</p>
                </div>
        ...
        <i class="fas fa-seedling"></i>{{ __('Register') }}
    </button>
                        </div>
                    </form>
                </div>
                <div class="card-footer text-center py-3 nature-gradient-light">
                    <p class="mb-0 text-dark">Already part of our community? 
                        <a href="{{ route('login') }}" class="text-success fw-bold">Sign in</a>
                    </p>
                </div>
            </div>
        </div>
